...
public class SettingsActivity extends PreferenceActivity {
    ...
    private static Preference.OnPreferenceChangeListener sBindPreferenceSummaryToValueListener = new Preference.OnPreferenceChangeListener() {
        ...
        public boolean onPreferenceChange(Preference preference, Object value) {
            ...
            if (preference instanceof ListPreference) {
                ...
                Log.d(TAG, "Set preference to " + stringValue);
            }
            return true;
        }
    };
    ...
    private void setupSimplePreferencesScreen() {
        ...
        findPreference("google_plus_enabled").setOnPreferenceChangeListener( new Preference.OnPreferenceChangeListener(){
            @Override
            public boolean onPreferenceChange(Preference preference, Object o) {
                Log.d(TAG, "Starting activity google_plus_enabled");
                Intent intent = new Intent(SettingsActivity.this, GoogleClient.class);
